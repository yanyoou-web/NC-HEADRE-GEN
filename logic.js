/* =========================================================
   【編集履歴】
   GitHubの記録から、同じ内容をまとめて一言で記載しています。
   ---------------------------------------------------------
   2026-07-24  編集履歴をこのファイルへまとめ、表計算の編集履歴を整理
   2026-07-23  塩ビゲタの登録内容を追加
   2026-07-23  アテ C-63-2 の高さを修正
   2026-07-23  表示言語を切り替える設定メニューを追加
   2026-07-23  ベトナム語の塩ビゲタ検索・アテ検索画面を追加
   2026-07-23  起動画面を見やすい大きさに拡大
   2026-07-23  起動直後の画面を整えてから表示するよう改善
   2026-07-23  デスクトップへのショートカット自動作成を廃止
   2026-07-23  日本語名のフォルダーからでも専用画面を開けるよう改善
   2026-07-23  保存場所を自動で見つけるよう改善
   2026-07-23  Edge専用画面の起動を安定化
   2026-07-23  Windowsから専用画面を開くための起動用ファイルを追加
   2026-07-23  塩ビゲタとアテをすぐ探せる一覧・絞り込み画面を追加
   2026-07-23  森精機のオフセット内容を調整
   2026-07-23  古い画面用ファイルを整理
   2026-07-23  最新版を取り込むための更新用ファイルを追加
   2026-07-22  内容の食い違いを解消し、最新状態に統一
   2026-07-21  全長・加工長さ・締め付けトルク欄で足し算などを入力可能に変更
   2026-07-21  Enterキーを押すと横ゲタ選択画面が飛ばされる問題を修正
   2026-07-21  数字キーでの選択がキーボードの違いに影響されにくいよう改善
   2026-07-21  手元の最新版を反映
   2026-07-19  使われていない古いファイルを整理
   2026-07-19  画面の使い方と計算内容の説明を追加
   2026-07-01  最初の版を登録
   ========================================================= */
...
const Logic = (() => {
  ...
  const enbiGetaMaster = {
    ...
    "B-41": { height: 32,   width: 13.5 },
    "B-43": { height: 23,   width: 13 },
    "B-44": { height: 19,   width: 18 },
    "B-45": { height: 27,   width: 13.5 },
    "B-46": { height: 45.5, width: 13.5 },
  ...
  ---------------------------------------------------------- */
  const ateMaster = {
    "C-1-1": { takasa: 44, phi: 13 },
    "C-1-2": { takasa: 44, phi: 9 },
    "C-2-1": { takasa: 43, phi: 13 },
    "C-2-2": { takasa: 43, phi: 9 },
    "C-3-1": { takasa: 42, phi: 12 },
    "C-3-2": { takasa: 42, phi: 13 },
    "C-4-1": { takasa: 40, phi: 15 },
    "C-5-1": { takasa: 39.5, phi: 13 },
    "C-5-2": { takasa: 39.5, phi: 15 },
    ...
    "C-15-1": { takasa: 28.5, phi: 13 },
    "C-15-2": { takasa: 28.5, phi: 22 },
    "C-16-1": { takasa: 28, phi: 22 },
    "C-17-1": { takasa: 27.5, phi: 13 },
    "C-18-1": { takasa: 25, phi: 20 },
    "C-19-1": { takasa: 24.5, phi: 20 },
    "C-20-1": { takasa: 22, phi: 30 },
    "C-20-2": { takasa: 22, phi: 23 },
    ...
    "C-30-1": { takasa: 3, phi: 30 },
    "C-30-2": { takasa: 3, phi: 35 },
    "C-31-1": { takasa: 4.5, phi: 35 },
    "C-32-1": { takasa: 6, phi: 30 },
    "C-33-1": { takasa: 7, phi: 30 },
    "C-34-1": { takasa: 8, phi: 30 },
    "C-35-1": { takasa: 9, phi: 30 },
    "C-36-1": { takasa: 10, phi: 25 },
    "C-36-2": { takasa: 10, phi: 30 },
    "C-36-3": { takasa: 10, phi: 39 },
    "C-37-1": { takasa: 10.5, phi: 25 },
    "C-37-2": { takasa: 10.5, phi: 30 },
    "C-37-3": { takasa: 10.5, phi: 39 },
    "C-38-1": { takasa: 11, phi: 30 },
    "C-39-1": { takasa: 11.5, phi: 25 },
    "C-40-1": { takasa: 12, phi: 25 },
    "C-40-2": { takasa: 12, phi: 39 },
    "C-41-1": { takasa: 13, phi: 25 },
    "C-41-2": { takasa: 13, phi: 30 },
    "C-42-1": { takasa: 13.3, phi: 61.4 },
    "C-43-1": { takasa: 14.45, phi: 25 },
    "C-44-1": { takasa: 14.5, phi: 25 },
    "C-45-1": { takasa: 15, phi: 20 },
    "C-46-1": { takasa: 15.5, phi: 30 },
    "C-46-2": { takasa: 15.5, phi: 39 },
    "C-46-3": { takasa: 15.5, phi: 45 },
    "C-47-1": { takasa: 17, phi: 20 },
    "C-47-2": { takasa: 17, phi: 30 },
    "C-48-1": { takasa: 17.5, phi: 30.6 },
    "C-49-1": { takasa: 18.5, phi: 19 },
    "C-50-1": { takasa: 19, phi: 30 },
    "C-51-1": { takasa: 20, phi: 20 },
    "C-51-2": { takasa: 20, phi: 25 },
    ...
    "C-59-1": { takasa: 28, phi: 18 },
    "C-59-2": { takasa: 28, phi: 20 },
    "C-60-1": { takasa: 29, phi: 14 },
    "C-61-1": { takasa: 29.5, phi: 13 },
    "C-62-1": { takasa: 30, phi: 18 },
    "C-62-2": { takasa: 30, phi: 23 },
    "C-62-3": { takasa: 30, phi: 31.7 },
    "C-63-1": { takasa: 30.5, phi: 15.5 },
    "C-63-2": { takasa: 30.6, phi: 50.4 },
    "C-64-1": { takasa: 31, phi: 18 },
    "C-65-1": { takasa: 31.5, phi: 12 },
    "C-65-2": { takasa: 31.5, phi: 13 },
    "C-66-1": { takasa: 32.5, phi: 16 },
    "C-67-1": { takasa: 33, phi: 20 },
    "C-67-2": { takasa: 33, phi: 22 },
    "C-68-1": { takasa: 33.25, phi: 20 },
    "C-68-2": { takasa: 33.25, phi: 18 },
    "C-69-1": { takasa: 34, phi: 20 },
    "C-69-2": { takasa: 34, phi: 22 },
    "C-70-1": { takasa: 35, phi: 18 },
    "C-70-2": { takasa: 35, phi: 23 },
    "C-71-1": { takasa: 35.5, phi: 13 },
    "C-72-1": { takasa: 36, phi: 13 },
    "C-73-1": { takasa: 36.75, phi: 19 },
    "C-74-1": { takasa: 37, phi: 16.2 },
    "C-74-2": { takasa: 37, phi: 18 },
    "C-75-1": { takasa: 37.5, phi: 15 },
    "C-75-2": { takasa: 37.5, phi: 18 },
    "C-75-3": { takasa: 37.5, phi: 20 },
    "C-76-1": { takasa: 38, phi: 15 },
    "C-76-2": { takasa: 38, phi: 13.3 },
    "C-76-3": { takasa: 38, phi: 18 },
    "C-77-1": { takasa: 38.5, phi: 18 },
    "C-77-2": { takasa: 38.5, phi: 13.3 },
    "C-78-1": { takasa: 39, phi: 30 },
    "C-79-1": { takasa: 40.5, phi: 13 },
    "C-79-2": { takasa: 40.5, phi: 15 },
    "C-79-3": { takasa: 40.5, phi: 17 },
    "C-79-4": { takasa: 40.5, phi: 20 },
    "C-80-1": { takasa: 41, phi: 15 },
    "C-81-1": { takasa: 41.5, phi: 13 },
    "C-82-1": { takasa: 42, phi: 9 },
    "C-83-1": { takasa: 42.5, phi: 9 },
    "C-83-2": { takasa: 42.5, phi: 13 },
